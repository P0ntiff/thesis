...
\multicolumn{1}{|l|}{\textbf{LIME}}     & \begin{tabular}[c]{@{}l@{}}Full model compatibility;\\ ease of adaption\end{tabular}                                                      & \begin{tabular}[c]{@{}l@{}}Explanation instability;\\ accuracy hyperparameter\end{tabular}                                  \\ \hline
